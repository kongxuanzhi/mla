...
int main(int argv, char* argc[]) {
    ...
    mla::tree::ClassificationTree * regreTree = new mla::tree::ClassificationTree(maxDepth, maxNodePath, isMultiThreadOn, 2, false);    
    ...
    mla::feature::feature_discretization(argc[5], vctTrainFeature);
    ...
    right = 0, tot = 0;
    mla::feature::feature_discretization(argc[5], vctTestFeature);
